...
with st.form("input_form"):
    ...
    traumtinte_preis_wunsch = st.number_input("Wunschpreis Traumtinte", value=18.5)
    sternentinte_preis_wunsch = st.number_input("Wunschpreis Sternentinte", value=185.0)
